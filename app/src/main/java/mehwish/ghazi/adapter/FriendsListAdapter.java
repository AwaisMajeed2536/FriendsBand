...
public class FriendsListAdapter extends ArrayAdapter<FriendsListAndRequestModel>{

    private List<FriendsListAndRequestModel> dataList;
    private Context context;

    public FriendsListAdapter(Context context, List<FriendsListAndRequestModel> data) {

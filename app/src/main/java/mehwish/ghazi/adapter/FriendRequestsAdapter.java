...
public class FriendRequestsAdapter extends ArrayAdapter<FriendsListAndRequestModel> implements View.OnClickListener {

    private List<FriendsListAndRequestModel> dataList;
    private Context context;

    public FriendRequestsAdapter(Context context, List<FriendsListAndRequestModel> data) {
        super(context, R.layout.friend_request_row_item,data);
        dataList = data;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.friend_request_row_item,parent,false);
